	...
	<div class="content singledefult">
							...
							<div class="category-slider" value="slider-category-<?php echo $post->ID ?>">
								<div id="slider-category" class="slider-category">
									...
									<div class="bx-controls bx-has-pager bx-has-controls-direction">
										<?php if(count($attachments)>7) { ?>
										<div class="bx-pager bx-custom-pager moved">
										<?php } else {?>
		...
		<div class="relatedPosts">
			<div class="relatedtitle">
				<h4><?php  esc_html_e('Articoli correlati','ragnar'); ?></h4>
			</div>
			<div class="related">			
			<?php
			$count = 0;
		...
		<div class = "post-navigation">
			<?php next_post_link('%link', '<div class="link-title-previous"><span>&#171; '.esc_html__('Precedente','ragnar').'</span><div class="prev-post-title">%title</div></div>' ,false,''); ?> 
			<?php previous_post_link('%link','<div class="link-title-next"><span>'.esc_html__('Successivo','ragnar').' &#187;</span><div class="next-post-title">%title</div></div>',false,''); ?> 
		</div>
