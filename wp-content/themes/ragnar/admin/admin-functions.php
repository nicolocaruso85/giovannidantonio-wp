...
function ragnar_of_head() { do_action( 'ragnar_of_head' ); }
...
function ragnar_optionsframework_admin_message() { 
...
add_action('admin_head', 'ragnar_optionsframework_admin_message'); 
...
/*-----------------------------------------------------------------------------------*/
	...
	function ragnar_of_get_header_classes_array() {
...
function ragnar_generate_options_css($newdata) {
	...
	add_action( 'wp_enqueue_scripts', 'ragnar_generate_options_css' );
