...
<!-- You can start editing here. -->
	<?php 
		...
		$cancel_reply_link = esc_html__('Cancel Reply','ragnar');  					
		$title_reply_to = esc_html__('Leave a Reply to','ragnar'); 			
		$label_submit = esc_html__('Leave a Comment','ragnar');  		
		$translation_comment_website = esc_html__('Website','ragnar');  	
		$translation_comment_required = esc_html__('required','ragnar');  
		$translation_comment_mail = esc_html__('Mail','ragnar'); 	
		$translation_comment_name = esc_html__('Name','ragnar');		
		$translation_comment_closed = esc_html__('Comments are closed.','ragnar');		
	?>
