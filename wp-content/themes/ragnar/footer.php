...
<footer>
	...
	<?php if(ragnar_globals('use_block3') && ragnar_globals('block3_username') && shortcode_exists( 'instagram-feed' ) ){ ?>
		...
		<?php
			echo do_shortcode('[instagram-feed id=517 id="'.esc_attr(ragnar_data('block3_username')).'" src="user_recent" imgl="instagram" imagepadding=0 cols="8" imageres=full  num="8" ]');
	}
	?>
	...
	<div id="footerbwrap">
		<div id="footerb">
			...
			<div class="copyright">	
				...
				© 2017 copyright Giovanni D'Antonio. Tutti i diritti riservati. <a target="_blank" href="http://dinamiqa.com/">made in dinamiqa</a>
