...
function sbi_welcome_screen_new_content() { ?>
    <div class="wrap about-wrap sbi-welcome">
        ...
        <p class="about-description"><?php _e("Let's take a look at what's new in version 2.9."); ?></p>

        <div class="changelog">
            <h3><?php _e('Introducing Permanent &amp; Backup feeds'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo plugins_url( 'img/welcome-permanent-cache.jpg' , __FILE__ ) ?>" style="padding: 10px 0 25px 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("<b>Permanent feeds</b> are useful if you have a feed with a group of posts which never needs to be updated. It creates a permanent record of the feed for optimal performance.<br />
                    <b>Backup feeds</b> store a backup set of posts just in case there's an issue retrieving your posts from the Instagram. The backup will be displayed instead of an empty feed."); ?></p>

                    <h4><?php _e("Directions"); ?></h4>
                    <p><?php _e("To make a feed \"permanent\" add the setting <code>permanent=\"true\"</code> to your shortcode. The feed will then never update with new posts."); ?></p>
                    <p><?php _e("You can also make a white list feed permanent using the checkbox labeled <b>\"This is a permanent white list (never needs to update)\"</b> when using <a href='https://smashballoon.com/guide-to-moderation-mode/' target='_blank'>moderation mode</a>."); ?></p>
                    <p><?php _e("Backup feeds are enabled by default though you can clear them or disable them on the \"Customize\" tab, \"Misc\" section."); ?></p>

                    <h3 style="padding-top: 20px;">Other Changes</h3>
                    <ul>
                        <li><?php _e("Icons are now generated as SVGs for a sharper look and more semantic markup", 'instagram-feed'); ?></li>
                        <li><?php _e("Added support for the WordPress Multilingual (WPML) plugin", 'instagram-feed'); ?></li>
                        <li><?php _e("Now includes support for translating dates and the word \"Share\" in the lightbox", 'instagram-feed'); ?></li>
                        <li><a href="https://smashballoon.com/instagram-feed/change-log/" target="_blank"><?php _e("See the full change log", 'instagram-feed'); ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
...
function sbi_welcome_header(){ ?>
    ...
    <div id="sbi-header">
        ...
        <p class="about-text">
            <?php _e("Thanks for installing <b>Version 2.9</b> of the Instagram Feed Pro plugin! Use the tabs below to see what's new or to get started using the plugin."); ?>
        </p>
    </div>
<?php }
    ...
    <input type="hidden" name="<?php echo $sb_instagram_customize_hidden_field; ?>" value="Y">
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr valign="top">
                    <th><label><?php _e("Enable Backup/Permanent caching"); ?></label></th>
                ...
                <tr valign="top">
                    <th scope="row"><label for="sb_instagram_disable_mob_swipe"><?php _e('Disable Mobile Swipe Code'); ?></label></th>
                    <td>
                        ...
                        <a class="sbi_tooltip_link" href="JavaScript:void(0);"><?php _e('What does this mean?'); ?></a>
                        <p class="sbi_tooltip"><?php _e("Check this box if you'd like to disable jQuery mobile in the JavaScript file. This will fix issues with jQuery versions 2.x and later."); ?></p>
                    </td>
                </tr>
    ...
    <?php if( $sbi_active_tab == 'display' ) { //Start Configure tab ?>
        ...
        <table class="sbi_shortcode_table">
            <tbody>
                ...
                <tr>
                    <td>hoverdisplay</td>
                    <td><?php _e("The info to display when hovering over the photo. Available options:<br />username, date, instagram, location, caption, likes"); ?></td>
                ...
                <tr>
                    <td>permanent</td>
                    <td><?php _e("Feed will never look for new posts from Instagram."); ?></td>
